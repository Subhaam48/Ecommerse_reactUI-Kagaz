      ...
      <footer className="footer">
        ...
        <div className="container">
                ...
                <div className="layout_item w-25">
                  <nav className="c-nav-tool">
                    ...
                    <ul className="c-nav-tool_list">
                      ...
                      <li>
                        <Link href="/pages/about-us" className="c-link">
                          About Us
                        </Link>
                      </li>
                ...
                <div className="layout_item w-25">
                  <nav className="c-nav-tool">
                    ...
                    <ul className="c-nav-tool_list">
                      ...
                      <li className="c-nav-tool_item">
                        {/* <Link to="/TermAndConditions" className="c-link">
                          Terms &amp; Conditions
                        </Link> */}
                ...
                <div className="layout_item w-25">
                  <ul className="flex">
                    <li>
                      <Link
                        to={
                          "https://www.facebook.com/subhamsekhar.pattanayak.94"
                        }
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                    ...
                    <li>
                      <Link to={"https://twitter.com/SubhamP18582"}>
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          viewBox="0 0 24 24"
                          width="32"
                    ...
                    <li>
                      <Link
                        to={
                          "https://www.instagram.com/subham_sekhar_pattanayak/"
                        }
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="footer_copyright">
            <p>&copy; 2022 The KagaZ Company Inc.</p>
          </div>
        </div>
      </footer>
    </div>
